 ...
 */
(function(f){f.$i=f.iQuery=function(){var e={};try{e=1==arguments.length?document.querySelectorAll(arguments[0]):document.querySelectorAll("body")}catch(k){e=arguments[0]}var d=function(d,a){void 0==this.constructor.length?d():a()},h=function(d,a,b){1==d.length?b():a()};return function(e){this.constructor=e;this.obj=function(){var a=arguments;if(void 0==constructor.length)return this.constructor;if(1==constructor.length)return this.constructor[0];[].map.call(this.constructor,function(b){a[0](b)})};
...
function(){4==this.readyState&&(200==this.status?"json"===a.dataType?b(eval("["+this.response+"]")[0]):b(this.response):b({error:this.statusText}))};for(key in a.data)d+=encodeURIComponent(key)+"="+encodeURIComponent(a.data[key])+"&";c.send(d)};this.scroll=function(){var a=this;d(function(){a.constructor.scrollIntoView()},function(){[].map.call(a.constructor,function(a){a.scrollIntoView()})})};this.addClass=function(a){var b=this;d(function(){b.constructor.className+=" "+a},function(){[].map.call(b.constructor,
function(b){b.className+=" "+a})})};this.removeClass=function(a){var b=this;d(function(){this.constructor.className=b.constructor.className.replace(a,"")},function(){[].map.call(b.constructor,function(b){b.className=b.className.replace(a,"")})})};this.lastChild=function(a){var b=this;d(function(){return b.constructor.lastChild},function(){return[].map.call(b.constructor,function(a){return a.lastChild})})};this.length=function(a){var b=this;d(function(){},function(){return b.constructor.length})};
this.onLine=function(){return f.navigator.onLine};return this}(e)};[].map.call(document.querySelectorAll("script"),function(e){void 0!=e.dataset.symbol&&(new Function("window."+e.dataset.symbol+" = iQuery;"))()})})(window);